...
char TestName[]="test00.inp";
ofstream outp;
#define outp cout
int  Subtasks[]=	{0,		15,		15,		20,		20,		30		}, Deno=100;

int  MaxN[]=		{0,		250000, 20,	250000,	250000, 250000 	};
int  MaxDifX[]=		{0,		1, 		20, 	250000, 250000,	250000 	};
...
void Gen(int pos, int Subtask, int maxN, int maxdifX, bool shuffle12, bool alldiff)
{
	...
	else cnttype2=rnd.next(Q), cnttype1=Q-1-cnttype2;
	...
	types.push_back(types[0]); types[0]=1;
